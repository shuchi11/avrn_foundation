                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 border"><input type="image" id="pic" name="pic" class="f2"><button class="btn btn-primary" type="submit">Upload signature</button></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 border" style="padding-top: 10px;"><input type="text" id="d1" name="d1" class="f2"></div>
                        </div>
          </div>
